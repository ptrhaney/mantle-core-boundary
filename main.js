require([
  ...
  const earthquakeLayer = new CSVLayer({
    url: "./small below 50km volcanoes mantle core boundary - small below 50km volcanoes.csv",
    ...
    renderer: {
      ...
      visualVariables: [
        ...
        },
        {
          ...
          stops: [
            { value: 8, color: [254, 240, 217], label: "4.5 - 8" },
            { value: 8.1, color: [179, 0, 0], label: ">7" }
          ]
        }
      ]
    },
